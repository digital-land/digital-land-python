...
def test_column_field_summary(tmp_path_factory):
...
# def test_column_field_summary_wkt_to_geometry(tmp_path_factory):
#     column_field_dir = tmp_path_factory.mktemp("column_field")
#     converted_dir = tmp_path_factory.mktemp("converted")
...
#     column_field_headers = ["column", "field"]
#     column_field_rows = [{"column": "column1", "field": "address"},
#                          {"column": "column2", "field": "address-text"},
#                          {"column": "column3", "field": "end-date"},
#                          {"column": "column4", "field": "entry-date"},
#                          {"column": "column5", "field": "latitude"},
...
#     column_field_summary = get_column_field_summary(pipeline, endpoint_resource_info, column_field_dir, converted_dir, specification_dir)
