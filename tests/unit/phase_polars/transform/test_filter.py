...
def test_filter_basic_match():
    ...
    # Create test data
    data = {"reference": ["1", "2", "3"], "name": ["One", "Two", "Three"]}
...
def test_filter_with_null_values():
    ...
    data = {"reference": ["1", "2", "3", "4"], "name": ["Alice", None, "Charlie", ""]}
    lf = pl.LazyFrame(data)
...
def test_filter_case_sensitive():
    ...
    data = {"reference": ["1", "2", "3"], "name": ["apple", "Apple", "APPLE"]}
    lf = pl.LazyFrame(data)
