...
def test_prune_phase():
    # Mock input stream
    input_stream = iter([
        {"row": {"organisation": "local-org:ABC", "start-date": "2022-02-02",  "entity": 12345678, "test": "XYZ"}},
        {"row": {"organisation": None, "start-date": "2022-03-02",  "entity": 34567812, "mock-column": "AAA"}},
        {"row": {"organisation": "local-org:MNO", "start-date": "2022-06-02",  "entity": 56781234, "mock-column": None}}
    ])
