...
class HarmonisePhase(Phase):
    ...
    def process(self, stream):
        ...
        row_count = 0
        logger.info("Starting harmonise phase...")
        ...
        try:
            ...
            logger.info(
                f"Harmonise phase completed in {elapsed_time:.2f} seconds "
                f"({row_count} rows processed, {row_count/elapsed_time:.2f} rows/sec)"
            )
